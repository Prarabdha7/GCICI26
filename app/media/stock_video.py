...
_STOPWORDS = {
    ...
    "with", "is", "are", "was", "were", "be", "been", "this", "that", "your",
    "you", "our", "we", "it", "not", "as", "by", "from", "its", "has", "have",
    "will", "can", "any", "into", "than", "their", "them", "just", "get",
    "now", "today", "more", "never", "every", "always", "terms", "apply",
}
